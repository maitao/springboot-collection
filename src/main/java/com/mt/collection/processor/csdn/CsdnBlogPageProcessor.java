...
public class CsdnBlogPageProcessor implements PageProcessor {
	Logger logger = Logger.getLogger(CsdnBlogPageProcessor.class);
...
//			new CsdnBlogDao().add(csdnBlog);
	...
	public static void main(String[] args) {
		...
		Spider.create(new CsdnBlogPageProcessor()).setDownloader(new HttpClientDownloader()).addUrl("https://blog.csdn.net/" + username).thread(5).run();
